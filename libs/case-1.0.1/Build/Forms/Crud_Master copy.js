...
class Crud_Master extends ODD {
            ...
            success:({inserts=[]})=>{
                ...
                this.#Insert_Request({
                    ...
                    success:({primaryNew,msg,resp})=>{
                        ...
                        k.SetState({stateName:k.#stateData.afterInsert,setLastPage:true});
                    }
                });
            }
        });        
    ...
    #Insert_Request({inserts=[],success,noInserts,noAddFields,noJoins}){
    ...
    SetState({stateName,noUseReloadAfter=false,setLastPage=false}){
        ...
        switch (this.#stateData.state) {
            ...
            case "reload":
                ...
                this.Reload({noUseReloadAfter,setLastPage});
            break;
    ...
    #State_SetTools({stateName,toolsSet=[]}){
        ...
        stateToolsData.tools.forEach(toolData => {
            ...
            if(toolSet.active != null) toolData.active = toolSet.active;
    ...
    Tools_OneToolSetShow({toolName,show,value,active}){

        var tool = this.#body.toolsGet().find(t=>t.name==toolName);
        //console.log("toolName:",toolName,"tool:",tool,"show:",show,"value:",value,"active",active);
