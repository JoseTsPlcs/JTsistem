    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            ...
            <div class="horizontal-bar">
                ...
                <ul class="dropdown-menu" aria-labelledby="helpIcon">
                    <li><a class="dropdown-item" href="#">¿Cómo se inserta una venta?</a></li>
                    <li><a class="dropdown-item" href="#">¿Cómo realizo un pago?</a></li>
                </ul>
            </div>
            
            <!-- Contenedor con título y formulario -->
