        ...
        cruds:[
          {
            ...
            script:{
              ...
              joins:[
                {
                  main:{table:"checkin_vehicles",field:"ID_VEHICLE"},
          ...
          },
          {
            ...
            script:{
              ...
              selects:[
                ...
                {table: "checkin_vehicles", field: "ID_VEHICLE"},
                {table: "checkin_vehicles", field: "DATE_ENTER"},
              ...
              fields:[
                ...
                {panel:"Datos del Vehiculo",col:8,colAllLevel:true,name:"vehiculo",box:{tipe:8,class:"w-100"},select:"ID_VEHICLE",load:{name:"ld-items",value:"value",show:"show"},descripcion:"vehiculo al que se le realizara la orden de trabajo"},
