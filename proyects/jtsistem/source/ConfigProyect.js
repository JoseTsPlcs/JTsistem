        ...
        cruds:[
            {
                ...
                conections:[
                    {main:{event:"reload",select:"ID_SALE"},join:{action:"join",crud:"fm-items",select:"ID_SALE"}},
                    {
                        main:{
                            event:"fieldUpdate",
                            fieldName:"total sin descuento",//sch_items.fields.find(f=>f.value=='dscto').name,
                        },
                        join:{
                            action:"print",
                            fieldName:"total",//sch_sales.fields.find(f=>f.value=='total').name,
                        }
                    }
                ],
            },
            {
                parent:"prnt-items",name:"fm-items",
